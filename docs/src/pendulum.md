...
![Energy error, Euler methods](figures/pendulum_energy_error_dt=0.1_euler.png)

![Energy error, other methods](figures/pendulum_energy_error_dt=0.1_other.png)
...
![Energy error, Gauss(2) midpoint variants](figures/pendulum_energy_error_dt=0.1_midpoint.png)
...
![Phase-space trajectory, Euler methods](figures/pendulum_solution_dt=0.1_euler.png)

## Long scenario (Δt = 1, t ≤ 10 000)

![Energy error, Euler methods](figures/pendulum_energy_error_dt=1.0_euler.png)

![Energy error, other methods](figures/pendulum_energy_error_dt=1.0_other.png)
...
![Phase-space trajectory, Euler methods](figures/pendulum_solution_dt=1.0_euler.png)
