...
# Horizon t = 1000 (nt = 10_000) at Δt = 0.1, at every precision — the local-frame stepping of
# `integrate_bounded` keeps the half precisions on a resolvable grid; see harmonic_oscillator.jl.
const t₀ = 0.0
const Δt = 0.1
const nt = 10_000
const t₁ = nt * Δt
