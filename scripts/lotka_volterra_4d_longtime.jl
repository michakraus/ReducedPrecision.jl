...
_lv_problem(::Type{T}, dt) where {T} = LV.lodeproblem(T.(LV.q₀), LV.A_quasicanonical_reduced, LV.B;
...
if reference !== nothing
    plot_solution_error(runs, reference; groups = LV4D_GROUPS,
        ...
        title = "Lotka–Volterra 4D — Solution Error (Δt = 0.1, t ≤ 100, vs. Float64 Gauss(8) at Δt = 0.01)")
